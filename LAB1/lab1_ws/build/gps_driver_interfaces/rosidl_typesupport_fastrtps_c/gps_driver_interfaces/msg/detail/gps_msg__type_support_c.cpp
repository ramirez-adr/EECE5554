...
#include "gps_driver_interfaces/msg/detail/gps_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // letter, utc
#include "rosidl_runtime_c/string_functions.h"  // letter, utc
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_gps_driver_interfaces
...
using _GpsMsg__ros_msg_type = gps_driver_interfaces__msg__GpsMsg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gps_driver_interfaces__msg__GpsMsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gps_driver_interfaces__msg__GpsMsg * ros_message = static_cast<const gps_driver_interfaces__msg__GpsMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gps_driver_interfaces__msg__GpsMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gps_driver_interfaces__msg__GpsMsg * ros_message = static_cast<gps_driver_interfaces__msg__GpsMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gps_driver_interfaces__msg__GpsMsg(cdr, ros_message);
}

static uint32_t _GpsMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gps_driver_interfaces__msg__GpsMsg(
...
static size_t _GpsMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gps_driver_interfaces__msg__GpsMsg(
