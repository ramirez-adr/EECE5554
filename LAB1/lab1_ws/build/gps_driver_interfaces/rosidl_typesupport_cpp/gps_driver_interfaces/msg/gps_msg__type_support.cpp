...
static const _GpsMsg_type_support_symbol_names_t _GpsMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_driver_interfaces, msg, GpsMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_driver_interfaces, msg, GpsMsg)),
  }
};
...
{
  return &::gps_driver_interfaces::msg::rosidl_typesupport_cpp::GpsMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_driver_interfaces, msg, GpsMsg)() {
  return get_message_type_support_handle<gps_driver_interfaces::msg::GpsMsg>();
}
